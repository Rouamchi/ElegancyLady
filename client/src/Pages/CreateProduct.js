...
const CreateProduct = () => {
  ...
  return (
    <>
      ...
      <div className="bg-gray-100 h-auto flex items-center justify-center">
        <div className="mt-0 mb-0 md:mt-20 md:mb-20 max-w-md w-full bg-white p-8 rounded-lg shadow-md">
          <img className="mx-auto h-32 w-auto mb-5 -mt-2" src={Logo} alt="Your Company" />
          <form encType="multipart/form-data" onSubmit={handleSubmit}>
            <div className="mb-2">
              <input id="imageSrc" type="file" onChange={handle} className="w-full border-2 rounded-md px-4 py-2 leading-5 transition duration-150 ease-in-out sm:text-sm sm:leading-5 resize-none focus:outline-none focus:border-amber-400" placeholder="Choose Image" />
            </div>
            <div className="mb-2">
              <textarea id="name" value={data.name} onChange={handle} rows={1} className="w-full border-2 rounded-md px-4 py-2 leading-5 transition duration-150 ease-in-out sm:text-sm sm:leading-5 resize-none focus:outline-none focus:border-amber-400" placeholder="Enter product name" />
            </div>
            <div className="mb-2">
              <textarea id="description" value={data.description} onChange={handle} rows={3} className="w-full border-2 rounded-md px-4 py-2 leading-5 transition duration-150 ease-in-out sm:text-sm sm:leading-5 resize-none focus:outline-none focus:border-amber-400" placeholder="Enter product description" />
            </div>
            <div className="mb-2">
              <textarea id="price" value={data.price} onChange={handle} rows={1} className="w-full border-2 rounded-md px-4 py-2 leading-5 transition duration-150 ease-in-out sm:text-sm sm:leading-5 resize-none focus:outline-none focus:border-amber-400" placeholder="Enter product price" />
            </div>
            <div className="mb-2">
              <textarea id="countInStock" value={data.countInStock} onChange={handle} rows={1} className="w-full border-2 rounded-md px-4 py-2 leading-5 transition duration-150 ease-in-out sm:text-sm sm:leading-5 resize-none focus:outline-none focus:border-amber-400" placeholder="Enter product quantity" />
            </div>
            <div className="mb-2">
              <textarea id="color" value={data.color} onChange={handle} rows={1} className="w-full border-2 rounded-md px-4 py-2 leading-5 transition duration-150 ease-in-out sm:text-sm sm:leading-5 resize-none focus:outline-none focus:border-amber-400" placeholder="Enter product color" />
            </div>
            <div className="flex items-center justify-between">
              <button type="submit" className="flex justify-center items-center bg-amber-400 hover:bg-amber-500 focus:outline-none focus:shadow-outline-amber text-white py-2 px-4 rounded-md transition duration-300 gap-2">
                Post
                <svg xmlns="http://www.w3.org/2000/svg" width={19} height={19} viewBox="0 0 24 24" id="send" fill="#fff">
                  <path fill="none" d="M0 0h24v24H0V0z" />
                  <path d="M3.4 20.4l17.45-7.48c.81-.35.81-1.49 0-1.84L3.4 3.6c-.66-.29-1.39.2-1.39.91L2 9.12c0 .5.37.93.87.99L17 12 2.87 13.88c-.5.07-.87.5-.87 1l.01 4.61c0 .71.73 1.2 1.39.91z" />
...
//   const url = "https://https://elegancyladyserver.onrender.com/Products"
//   const [data, setData] = useState({
//     name: "",
//     imageSrc: "",
//     description: "",
