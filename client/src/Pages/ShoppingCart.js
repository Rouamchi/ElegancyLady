      ...
      <>
        ...
        <div className="w-full min-h-screen bg-gray-100 flex flex-col">
          <div className="block lg:flex" >
              ...
              <div className="flex">
                <div className="md:flex items-strech py-0 border-t border-gray-300 ml-4 mb-4">
                  <div className="md:w-4/12 2xl:w-1/4 w-full mb-4">
                    <img className="object-center object-cover md:block w-1/2 lg:w-auto lg:h-auto"
                  ...
                  <div className="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                    ...
                    <div>
                      <div className="flex items-center justify-between w-full pb-4 lg:pl-6">
                        <p className="text-base font-black leading-none text-gray-800 dark:text-white">
                          {singleProduct.name}
                        </p>
                      </div>
                      <p className="text-sm leading-3 text-gray-600 dark:text-white pt-2 lg:pl-6">
                        Height: 10 inches
                      </p>
                      <p className="text-sm leading-3 text-gray-600 dark:text-white py-4 lg:pl-6">
                        Color: {singleProduct.color}
                      </p>
                      <p className="w-96 text-sm leading-3 text-gray-600 dark:text-white lg:pl-6">
                        Composition: 100% calf leather
                      </p>
                      <div className="flex items-center justify-between pt-5">
                        <div className="flex itemms-center lg:pl-6">
                          <Link to="/Favorites" className="text-md font-bold leading-3 text-amber-500 hover:text-amber-400 dark:text-white cursor-pointer lg:mt-4">
                            Add to favorites
                          </Link>
                          <p className="text-sm leading-3 text-md font-bold text-red-500 hover:text-red-600 pl-5 cursor-pointer lg:mt-4">
                            Remove
                          </p>
                        </div>
                      </div>
                      <p className="text-base font-black lg:mb-6 lg:ml-6 mt-6 leading-none text-gray-800 dark:text-white block lg:flex">
            ...
            {/* SAMMARY */}
            <div className="border-2 border-red-800 lg:ml-28 lg:mt-24 lg:w-80 md:w-8/12 w-full pb-6 mb-7 bg-gray-300 dark:bg-gray-900 h-96">
                  ...
                  <div className="flex items-center justify-between pt-5">
                    ...
                    <p className="text-base leading-none text-gray-800 dark:text-white">
                      {singleProduct.countInStock > 0 ? (
                        <select className="bg-gray-300" as="select" value={quantity}
                ...
                <div>
                  <div className="flex items-center pb-2 lg:pb-6 justify-between lg:pt-5 pt-5">
                    ...
                    <p className="text-2xl font-bold leading-normal text-right text-gray-800 dark:text-white">
                      {singleProduct.price * quantity} DH </p>
                  </div>
