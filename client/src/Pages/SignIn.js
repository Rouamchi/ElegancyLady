      ...
      <form className='grid justify-items-stretch justify-center mx-6 my-8 md:mx-8 '>
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
          <button
            onClick={click}
            type="submit"
            className="flex w-full justify-center rounded-md bg-amber-400 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-amber-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">
            Sign In{" "}
          </button>
        </div>
      </form>
