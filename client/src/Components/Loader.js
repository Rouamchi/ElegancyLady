...
const Loader = () => {
  return (
    <>
      ...
      <br />
      <div className=' text-center justify-center mt-2 md:ml-64 md:pl-6 -ml-44'>
        <div className="animate-spin inline-block w-8 h-8 md:w-10 md:h-10 border-[3px] border-current border-t-transparent text-gray-400 rounded-full" role="status" aria-label="loading">
        </div>
      </div>
