            ...
            <div className="sm:flex sm:items-start">
              ...
              <div className="mx-auto flex-shrink-0 flex items-center justify-center h-6 w-6 lg:h-12 lg:w-12 rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                <svg width="64px"
                  ...
                  stroke="currentColor"
                  fill="none" viewBox="0 0 24.00 24.00" xmlns="http://www.w3.org/2000/svg" strokeWidth="0.45600000000000007">
                  ...
                  <g id="SVGRepo_iconCarrier">
                    ...
                    />
                    <path fill="#ef4444" fillRule="evenodd" clipRule="evenodd"
              ...
              <div className="mt-3 ml-3 lg:mr-0 text-left  sm:mt-0 sm:ml-4 sm:text-left">
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    {" "}
                    <span className="font-bold"> Existing Customer? </span> You Need To
                    <span className="font-bold"> Sign In </span>
                    With Your Account.{" "}
                  </p>
                  <p className="text-sm text-gray-500">
                    {" "}
                    <span className="font-bold"> New Customer? </span> You Need To
