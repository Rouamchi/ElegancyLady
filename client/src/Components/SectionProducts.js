        ...
        <div
          ...
          <div className="bg-gray-900 bg-opacity-50 flex items-center h-full">
            <div className=" px-6 md:px-10 max-w-xl md:max-w-2xl">
              <h2 className="text-xl md:text-3xl text-white font-semibold  mt-4 md:mt-4">PRODUCTS OF ELEGANCY LADY</h2>
              ...
              <Link to="/" className="flex items-center mt-1 md:mt-4 px-3 py-2 bg:transparent text-white text-sm uppercase font-medium rounded hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
