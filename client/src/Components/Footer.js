        ...
        <div className="container px-6 py-12 mx-auto">
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 md:grid-cols-4">
            <div className="sm:col-span-2">
              ...
              <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row">
                ...
                <Link to="/SignIn" className="w-full px-6 py-2.5 text-sm font-medium tracking-wider text-white transition-colors duration-300 md:w-auto md:mx-4 focus:outline-none bg-amber-400 rounded-lg hover:bg-amber-400 focus:ring focus:ring-black focus:ring-opacity-80">
                  Send
                </Link>
              </div>
            </div>
            ...
            <div>
              <p className="font-semibold text-white dark:text-gray-400">⚜️ Pages ⚜️</p>
            ...
            <div>
              <p className="font-semibold text-white dark:text-gray-400">⚜️ Contact Us ⚜️</p>

              <div className="flex flex-col items-start mt-5 space-y-2">
                <Link to="https://www.instagram.com/elegancy_lady_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target='_blank' rel='noreferrer'
                  ...
                  ⚜️ Instagram Page </Link>
                <Link to="https://www.facebook.com/profile.php?id=61559465095245&mibextid=ZbWKwL" target='_blank' rel='noreferrer'
                  className="text-amber-400 transition-colors duration-300 dark:text-amber-400 dark:hover:text-amber-400 hover:underline hover:cursor-pointer hover:text-white">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex gap-3 hover:cursor-pointer">
              ...
              <Link to='https://www.instagram.com/elegancy_lady_?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==' target='_blank'>
                <button className="bg-amber-400 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded-full">
